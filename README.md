...
[v1.0.3 release](https://github.com/hakiyaka/capsule/releases/tag/v1.0.3) and
verify its [SHA-256 sidecar](https://github.com/hakiyaka/capsule/releases/download/v1.0.3/capsule-1.0.3-source.zip.sha256)
